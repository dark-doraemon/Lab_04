...
isElementPresent = WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Swag Labs/button_Open Menu'), 3)

if (!(isElementPresent)) {
    WebUI.closeBrowser()

    KeywordUtil.markFailed('Không tìm thấy phần tử trên trang')
}
